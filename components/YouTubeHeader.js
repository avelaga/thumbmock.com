  ...
  return (
    <header className={styles.header}>
      ...
      <div className={styles.right}>
        ...
        <button className={styles.shuffleButton} onClick={onShuffle} title="Shuffle video order">
          <svg viewBox="0 0 24 24" width="20" height="20">
